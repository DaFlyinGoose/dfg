...
return array(
	...
	'edit_fields' => array(
		...
		'image' => array(
			...
			'type' => 'image',
			'naming' => 'random',
			'location' => public_path() . config('laravel-blog::originals_dir'),
			'size_limit' => 5,
			'sizes' => array(
				array(
					config('laravel-blog::thumbnail_image_width'),
					config('laravel-blog::thumbnail_image_height'),
					'crop',
					public_path() . config('laravel-blog::thumbnails_image_dir'),
					100
				),
				array(
					config('laravel-blog::details_image_max_width'),
					config('laravel-blog::details_image_max_height'),
					'auto',
					public_path() . config('laravel-blog::details_image_dir'),
					100
				),
			),
		),
