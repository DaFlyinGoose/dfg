var gulp = require('gulp'),
  ...
  paths = {
    src: {
      views: 'resources/assets/views/*.blade.php',
      sass_vendor: ['resources/assets/sass/bootstrap.scss'],
      sass_bundle: ['resources/assets/sass/layout.scss', '!src/sass/bootstrap.scss', '!src/sass/pages/*.scss'],
      sass_pages: ['resources/assets/sass/pages/*.scss'],
      vendor: ['resources/assets/vendor/**/*'], // non bower supported vendor scripts
